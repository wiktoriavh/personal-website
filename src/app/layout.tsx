...
import { env } from "~/env";
import { HiddenSvgBlobs } from "~/components/HiddenSvgBlobs/HiddenSvgBlobs";
  ...
  return (
    <html lang="en">
      <body className="row-auto mx-auto grid min-h-screen max-w-7xl grid-flow-row grid-cols-12 gap-5 bg-wi-black-50 px-4 font-sans">
        <Navigation />
        <main className="col-span-full grid-cols-subgrid">
          {children}
          ...
          <svg
            ...
            className="pointer-events-none absolute right-20 top-20 -z-10"
          >
            <path
        ...
        <footer className="col-span-fullmx-auto flex w-[70ch] max-w-7xl content-center items-center gap-4 p-4 text-2xl">
          <LogoBlob height={80} />
